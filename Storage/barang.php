                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-shopping-cart" aria-hidden="true"></i>
                            </a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                </div><!-- /.container-fluid -->
        ...
        <section class="banner_area">
            <div class="container">
                <div class="banner_content">
                    <h4>Our Storage</h4>
                    <!-- <a href="#">Home</a> -->
                    <a class="active" href="menu-list.html">List</a>
                </div>
            </div>
        </section>
        <!--================End Banner Area =================-->
            ...
            <div class="container">
                <div class="popular_filter">
                    <ul>
                        ...
                        <li data-filter=".break"><a href="">Accessoris</a></li>
                        <li data-filter=".lunch"><a href="">Food</a></li>
                        <li data-filter=".dinner"><a href="">Medicin</a></li>
                    </ul>
                </div>
                <div class="p_recype_item_main">
                    <div class="row p_recype_item_active">
                        <div class="col-md-6 break snacks">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/aksesoris2.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Sisir Bulu</h3></a>
                                    <h4>Rp35.000</h4>
                                    <p></p>
                        ...
                        <div class="col-md-6 break coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/aksesoris3.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Alat Penggaruk</h3></a>
                                    <h4>Rp60.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 break coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/aksesoris4.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a><h3>Kandang Kucing</h3></a>
                                    <h4>Rp250.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 break coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/aksesoris5.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Tempat Minum</h3></a>
                                    <h4>Rp52.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 break coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/aksesoris6.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3> Mainan Bulu</h3></a>
                                    <h4>Rp30.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 break coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/aksesoris7.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Tempat Tidur Kucing</h3></a>
                                    <h4>Rp320.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 lunch snacks">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/food1.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Whiskas Kaleng</h3></a>
                                    <h4>Rp40.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 lunch coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/food2.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Royal Canin Kaleng</h3></a>
                                    <h4>Rp42.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 lunch coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/food3.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Equilis</h3></a>
                                    <h4>Rp45.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 lunch coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/food4.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>BOLD</h3></a>
                                    <h4>Rp52.000</h4>
                        ...
                        <div class="col-md-6 lunch coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/food5.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Whiskas Junior</h3></a>
                                    <h4>Rp30.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 lunch coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/food6.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Me-O</h3></a>
                                    <h4>Rp60.000</h4>
                        ...
                        <div class="col-md-6 lunch coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/food7.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>ProDiet</h3></a>
                                    <h4>Rp75.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 lunch coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/food8.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Super Cat</h3></a>
                                    <h4>Rp50.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 lunch coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/food9.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Maxi</h3></a>
                                    <h4>Rp35.000</h4>
                        ...
                        <div class="col-md-6 lunch coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/food10.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Willowy</h3></a>
                                    <h4>Rp80.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 dinner snacks">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/obat1.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Vitamin kucing</h3></a>
                                    <h4>Rp55.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 dinner snacks">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/obat2.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Susu Kucing</h3></a>
                                    <h4>Rp100.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 dinner coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/obat3.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Vitamin Bulu</h3></a>
                                    <h4>Rp45.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 dinner coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/obat4.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Bio Enermection</h3></a>
                                    <h4>Rp120.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 dinner coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/obat5.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Scourban</h3></a>
                                    <h4>Rp75.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
                        ...
                        <div class="col-md-6 dinner coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="img/recype/obat6.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Antiseptik</h3></a>
                                    <h4>Rp30.000</h4>
                                    <p></p>
                                    <a class="read_mor_btn" href="#">Add To Cart</a>
                                    <!-- <ul>
