		...
		<div class="services-main">
			...
			<div class="ser-bottom">
				<div class="col-md-4 ser-grid">
					...
					<h4><a href="../pets/Login/login.php">
						<?php
          					if(isset($_SESSION['member'])){
            					echo '<li><a href="grooming.php">Grooming</a></li>';
          					}
        				?></a></h4>
				...
				<div class="col-md-4 ser-grid">
					...
					<h4><a href="../pets/Login/login.php">Storage</a></h4>
				...
				<div class="col-md-4 ser-grid">
					...
					<h4><a href="../pets/Login/login.php">Sleepover</a></h4>
			...
			<!-- <div class="contact-bottom">
				...
				<div class="col-md-6 contact-right">
				    ...
				    <ul>
				    	...
				    	<li><a href="mailto:amalia.u@mhs.unsyiah.ac.id"><span class="glyphicon glyphicon-envelope" aria-hidden="true"> </span>amalia.u@mhs.unsyiah.ac.id</a></li>
				    </ul>
				</div>
			  <div class="clearfix"> </div>
			</div>
